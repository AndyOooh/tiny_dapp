                ...
                return (
                  <>
                    <button
                      ...
                      // className='py-1 px-2 font-bold rounded-sm bg-gradient-to-r from-blue-500 to-purple-500'
                      className='py-1 px-2 rounded-md border-4 [border-image:linear-gradient(to_right,teal,purple)_1]'>
              ...
              return (
                <Flex gap='2'>
                  <Button onClick={openChainModal} variant='outline'>
                    {chain?.iconUrl ? <img src={chain.iconUrl} alt={chain.name ?? "Chain icon"} style={{ width: 12, height: 12 }} /> : <GearIcon />}
                    {/* {chain?.name} */}
                  </Button>
